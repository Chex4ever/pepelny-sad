...
- Эталон **раскладки** пола 5×5: `EDITOR_FLOOR_5X5_TILE_REFERENCE` — 25 букв, каждая **4 раза** (по одной на каждый `@` штампа 3×2); в игре глиф один, буквы только для теста. См. `docs/ISO_LAYOUT.md`.
